...
import { Badge } from "@/components/ui/badge"; // Đảm bảo import Badge nếu bạn chưa có
...
const ProductCard = ({ product, index }: { product: Product; index: number }) => {
  ...
  return (
    ...
    >
      <div className={`aspect-video overflow-hidden bg-gradient-to-r ${product.colorClass} relative`}>
        <img
          src={
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        >
          ...
          <p className="text-muted-foreground flex-1">
            <strong>Thương Hiệu: </strong>{product.thuonghieu}
          </p>
          <p className="text-muted-foreground flex-1">
            <strong>Số Lượng Đã Bán: </strong>{product.soLuongDaBan}
          </p>
          <p className="text-muted-foreground flex-1">
            <strong>Số Lượng Còn Lại: </strong>{product.soLuong}
          </p>
        </Link>
      </div>
    </div>
    ...
    <section id="products" className="py-24 px-6 bg-gradient-to-b from-white to-secondary/30">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-medium mb-4 gradient-text">Sản Phẩm Bán Chạy</h2>
