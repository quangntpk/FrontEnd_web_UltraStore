...
import Product3D from "./Product3D"; // Import your 3D component

const Hero = () => {
  return (
    <section className="min-h-screen pt-32 pb-16 px-6 flex flex-col justify-center relative overflow-hidden">
      <div className="container mx-auto max-w-6xl z-10 flex flex-col md:flex-row items-center">
        {/* Left: Text Content */}
        <div className="md:w-1/2">
          ...
          <h1
            className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tight mb-6 md:mb-8 animate-fade-in opacity-0 gradient-text"
          ...
          <p
            className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 animate-fade-in opacity-0"
          ...
          >
            <a
              href="#products"
              className="inline-flex items-center justify-center h-12 px-6 gradient-bg text-white rounded-full hover:opacity-90 transition-opacity"
            >
              Explore Products
            </a>
            <a
              href="#about"
              className="inline-flex items-center justify-center h-12 px-6 border border-primary/30 rounded-full hover:bg-primary/5 transition-colors"
            >
              Learn More
