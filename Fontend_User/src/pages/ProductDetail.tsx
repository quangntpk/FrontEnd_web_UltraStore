...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const fetchProductAndComments = async () => {
      ...
      try {
        ...
        // Tính điểm trung bình từ danhGia
        ...
        // Cập nhật rating vào formattedProducts
  ...
  const handleToggleLike = async () => {
    ...
    if (isLiked) {
      ...
      const yeuThichData = {
        ...
        hoTen: hoTen,
        soLuongYeuThich: 1, // Giá trị mặc định
      ...
      try {
        ...
        setIsLiked(true);
        setLikedId(addedFavorite.maYeuThich); // Lấy maYeuThich từ response
  ...
  if (loading) {
    return <div className="pt-24 pb-16 px-6 min-h-screen flex items-center justify-center"><p>Loading product details...</p></div>;
  }
